...
import { ListItem, IDropDownSettings } from "./sdek-ng-multiselect.model";

export const DROPDOWN_CONTROL_VALUE_ACCESSOR: any = {
  provide: NG_VALUE_ACCESSOR,
  useExisting: forwardRef(() => SdekNgMultiSelectComponent),
  multi: true
};
const noop = () => {};
...
export class SdekNgMultiSelectComponent implements ControlValueAccessor {
